                    ...
                    <!-- <el-scrollbar :height="winHeight+'px'"> -->
                        <div class="form-widget-container" :style="{height:winHeight+'px'}">
                            <div class="editor-container-box"  :style="{height:pageRaelheight+'px'}">
                                <div class="editor-content" id="editor-content" :style="{height:pageRaelheight+'px'}" @click="focusEditor">
...
export default defineComponent({
  ...
  setup() {
        ...
        engineInstance.on("change", () => {//时时监听输入值
          ...
          nextTick(()=>{
            ...
            state.timer= setTimeout(() => {
              ...
              clearInterval(state.time); 
               // 水印布局 加水印的dom     水印文本
              var watermark_txt = "<div>仅供环越检查站专用 请注意保护隐私</div>" ;
   ...
   const watermark=(settings:any)=>{
        //默认设置
        var defaultSettings = {
            watermarl_element: settings.watermarl_element||"body",
            watermark_txt: settings.watermark_txt||"源思黑体",
